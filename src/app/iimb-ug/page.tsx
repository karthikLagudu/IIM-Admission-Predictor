    ...
    <div className="ug-page">
      <section className="ug-hero">
        <div className="shell ug-hero-grid">
          ...
          <aside>
            <span>Built for honest uncertainty</span>
            <strong>Official rules where known. “Data required” where they are not.</strong>
            <p>The current PI-call cutoff, UG normalization inputs, final cutoff, programme closing scores and calibrated admission probability are not public.</p>
          </aside>
        </div>
      </section>
