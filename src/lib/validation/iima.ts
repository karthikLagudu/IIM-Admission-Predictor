...
export const candidateInputSchema = z.object({
  ...
  catVarcScaledScore: z.number().min(0).max(204),
  catDilrScaledScore: z.number().min(0).max(204),
  catQaScaledScore: z.number().min(0).max(204),
  catOverallScaledScore: z.number().min(0).max(204),
